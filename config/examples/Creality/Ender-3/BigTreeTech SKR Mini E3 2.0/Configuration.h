...
#define STRING_CONFIG_H_AUTHOR "(KC, Ender-3 v1.0)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 143.01
  #define DEFAULT_bedKi 27.02
  #define DEFAULT_bedKd 504.54
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.9, -5.7, 0 }
